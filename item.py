...
# Beginnings of cleaned up item class
'''
class Item:
...
it = {'health potion': {'name': 'Small health potion',
        ...
        'lingo': {'name': 'The Kialtou',
                        'sg': 'The Kialtou',
                        'pl': 'Kialtous',
                        'desc': 'A short dagger coated in blood\n--- The engraving on the blade reads:\n--- kialtoulo\'uta nakoron\n--- a quote in liakra pantakifosthulru\n--- A special gift to Lingo',
                        'modification': {'attack': 3, 'speed': 2, 'defense': -2},
                        'slot': 'weapon',
                        'prop': {'sting': True, 'stingpos': ["speed", "attack"], 'stingnum': 1, 'soul': True, 'legendary': True,}},
