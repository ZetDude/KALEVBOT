## Based on Frank Liang's hyphenation algorithm
...
def build_break_tree(patterns):
    ...
    for pattern in patterns.split():
        insert_pattern(tree, pattern)
    return tree

def build_exception_dict(exceptions):
    exdict = {}
...
default_exception_dictionary = build_exception_dict("""
as-so-ciate as-so-ciates dec-li-na-tion ob-lig-a-tory phil-an-thropic re-cog-ni-zance ref-or-ma-tion
